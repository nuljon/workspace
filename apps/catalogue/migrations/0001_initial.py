    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'option',
                    models.CharField(max_length=255, verbose_name='Option'),
                ),
            ],
            options={
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            (
                                'Required',
                                'Required - a value for this option must be specified',
                            ),
                            (
                                'Optional',
                                'Optional - a value for this option can be omitted',
                            ),
                        ],
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    oscar.models.fields.NullCharField(
                        ...
                        verbose_name='UPC',
                        max_length=64,
                        help_text='Universal Product Code (UPC) is an identifier for a product which is not specific to a particular  supplier. Eg an ISBN for a book.',
                    ),
                ),
                (
                    'title',
                    models.CharField(
                        max_length=255, verbose_name='Title', blank=True
                    ),
                ),
                (
                    'slug',
                ...
                (
                    'rating',
                    models.FloatField(
                        editable=False, verbose_name='Rating', null=True
                    ),
                ),
                (
                    'date_created',
            ...
            fields=[
                    ...
                    models.SlugField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                ...
                                message="Code can only contain the letters a-z, A-Z, digits, minus and underscores, and can't start with a digit",
                            )
                        ],
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text='Select an option group if using type "Option"',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'value_text',
                    models.TextField(
                        blank=True, verbose_name='Text', null=True
                    ),
                ),
                (
                    'value_integer',
                    models.IntegerField(
                        blank=True, verbose_name='Integer', null=True
                    ),
                ),
                (
                    'value_boolean',
                ...
                (
                    'value_float',
                    models.FloatField(
                        blank=True, verbose_name='Float', null=True
                    ),
                ),
                (
                    'value_richtext',
                    models.TextField(
                        blank=True, verbose_name='Richtext', null=True
                    ),
                ),
                (
                    'value_date',
                    models.DateField(
                        blank=True, verbose_name='Date', null=True
                    ),
                ),
                (
                    'value_file',
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        ...
                        help_text='An image with a display order of zero will be the primary image for a product',
                    ),
                ),
                (
                    'date_created',
        ...
        migrations.AlterUniqueTogether(
            name='productimage', unique_together={('product', 'display_order')}
        ),
        migrations.AlterUniqueTogether(
            name='productcategory', unique_together={('product', 'category')}
        ),
        migrations.AlterUniqueTogether(
            name='productattributevalue',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                help_text='A product attribute is something that this product may have, such as a size, as specified by its class',
                to='catalogue.ProductAttribute',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                help_text="Options are values that can be associated with a item when it is added to a customer's basket.  This could be something like a personalised message to be printed on a T-shirt.",
                to='catalogue.Option',
                blank=True,
            ),
            preserve_default=True,
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                help_text='These are products that are recommended to accompany the main product.',
                to='catalogue.Product',
